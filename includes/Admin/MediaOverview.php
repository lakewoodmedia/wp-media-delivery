...
class MediaOverview
{
    ...
    {
        // No longer adding a separate menu item since we're using tabs
        // The Media Overview will be accessible through the tabbed interface
    }
    ...
    public function total_media_files_field()
    {
        ...
        echo '<span class="advmo-stat-label">' . esc_html__('Media Attachments', 'wp-media-delivery') . '</span>';
        echo '</p>';
    ...
    public function non_offloaded_media_field()
    {
        ...
        if ($non_offloaded_count === 0) {
            ...
            echo '<span class="advmo-stat-label">' . esc_html__('Media Attachment', 'wp-media-delivery') . '</span>';
        } else {
            echo '<span class="advmo-stat-label">' . esc_html__('Media Attachments', 'wp-media-delivery') . '</span>';
        }
        echo '</p>';
    ...
    public function bulk_offload_media_field()
    {
        ...
        echo __('The offloading process handles up to 50 media files per batch. If you have more than 50 files, you will need to run the bulk offload multiple times. This process runs in the background—you can close this page after starting.', 'wp-media-delivery') . '</p><br />';
